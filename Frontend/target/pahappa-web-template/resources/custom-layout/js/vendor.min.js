!function(e, t) {
    ...
    C.extend = C.fn.extend = function() {
        ...
        for ("boolean" == typeof o && (l = o, o = arguments[s] || {}, s++), "object" == typeof o || b(o) || (o = {}), s === a && (o = this, s--); s < a; s++)
            if (null != (e = arguments[s]))
                for (t in e)
                    n = e[t],
                    "__proto__" !== t && o !== n && (l && n && (C.isPlainObject(n) || (i = Array.isArray(n))) ? (r = o[t], r = i && !Array.isArray(r) ? [] : i || C.isPlainObject(r) ? r : {}, i = !1, o[t] = C.extend(l, r, n)) : void 0 !== n && (o[t] = n));
        return o
    },
    C.extend({
    ...
    var p = function(n) {
            ...
            if (!i && (x(t), t = t || E, T)) {
                ...
                if (p.qsa && !D[e + " "] && (!m || !m.test(e)) && (1 !== d || "object" !== t.nodeName.toLowerCase())) {
                    if (u = e, f = t, 1 === d && (X.test(e) || z.test(e))) {
                        for ((f = ne.test(e) && ge(t.parentNode) || t) === t && p.scope || ((a = t.getAttribute("id")) ? a = a.replace(re, oe) : t.setAttribute("id", a = C)), o = (c = h(e)).length; o--;)
        ...
        for (e in p = ae.support = {}, r = ae.isXML = function(e) {
            ...
            if (x(e), p.matchesSelector && T && !D[t + " "] && (!a || !a.test(t)) && (!m || !m.test(t)))
                try {
                    var n = u.call(e, t);
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t,
                        n = !e[6] && e[2];
                    return V.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && K.test(n) && (t = h(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                }
            },
            filter: {
                TAG: function(e) {
                    ...
                    return 1 === g && 0 === m ? function(e) {
                        ...
                        if (u) {
                            ...
                            if (l = [y ? u.firstChild : u.lastChild], y && d) {
                                ...
                                for (; (s = ++a && s && s[c] || (p = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++p || (d && ((r = (o = s[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] = [k, p]), s !== e));)
                                    ;
            ...
            pseudos: {
                ...
                lang: ce(function(n) {
                    return Y.test(n || "") || ae.error("unsupported lang: " + n), n = n.replace(ie, f).toLowerCase(), function(e) {
                        var t;
                        do {
        ...
        function ye(s, e, t) {
            ...
            return e.first ? function(e, t, n) {
                ...
                if (n) {
                    ...
                    for (; e = e[a];)
                        if (1 === e.nodeType || u)
                            if (i = (r = e[C] || (e[C] = {}))[e.uniqueID] || (r[e.uniqueID] = {}), l && l === e.nodeName.toLowerCase())
                                e = e[a] || e;
                            else {
    ...
    (C.fn.init = function(e, t, n) {
        ...
        if (i[1]) {
            if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : T, !0)), j.test(i[1]) && C.isPlainObject(t))
                for (var i in t)
    ...
    C.Callbacks = function(i) {
        var n;
        i = "string" == typeof i ? (n = {}, C.each(i.match(H) || [], function(e, t) {
            n[t] = !0
        }), n) : C.extend({}, i);
        function r() {
    ...
    C.extend({
                            ...
                            return function() {
                                function e() {
                                    ...
                                    if (!(r < l)) {
                                        ...
                                        b(t) ? a ? t.call(e, c(l, o, M, a), c(l, o, I, a)) : (l++, t.call(e, c(l, o, M, a), c(l, o, I, a), c(l, o, M, o.notifyWith))) : (s !== M && (n = void 0, i = [e]), (a || o.resolveWith)(n, i))
                                    }
                                }
                                var n = this,
                                    i = arguments,
                                    t = a ? e : function() {
                                        try {
                                            ...
                                            l <= r + 1 && (s !== I && (n = void 0, i = [e]), o.rejectWith(n, i))
                                        }
                                    };
        ...
        when: function(e) {
            ...
            var n = arguments.length,
                ...
                o = a.call(arguments),
                s = C.Deferred();
            if (n <= 1 && (q(e, s.done(t(i)).resolve, s.reject, !n), "pending" === s.state() || b(o[i] && o[i].then)))
                return s.then();
            for (; i--;)
                q(o[i], t(i), s.reject);
            return s.promise()
    ...
    C.ready.then = B.then,
    "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? E.setTimeout(C.ready) : (T.addEventListener("DOMContentLoaded", W), E.addEventListener("load", W));
    ...
    C.fn.extend({
        data: function(n, e) {
            ...
            if (this.length && (r = V.get(o), 1 === o.nodeType && !Y.get(o, "hasDataAttrs"))) {
                for (t = s.length; t--;)
                    s[t] && 0 === (i = s[t].name).indexOf("data-") && (i = z(i.slice(5)), Z(o, i, r[i]));
    ...
    C.extend({
        queue: function(e, t, n) {
            var i;
            if (e)
                return t = (t || "fx") + "queue", i = Y.get(e, t), n && (!i || Array.isArray(n) ? i = Y.access(e, t, C.makeArray(n)) : i.push(n)), i || []
        },
    ...
    function ce(e, t) {
        for (var n, i, r, o, s, a, l = [], c = 0, u = e.length; c < u; c++)
            (i = e[c]).style && (n = i.style.display, t ? ("none" === n && (l[c] = Y.get(i, "display") || null, l[c] || (i.style.display = "")), "" === i.style.display && se(i) && (l[c] = (a = o = r = void 0, o = i.ownerDocument, s = i.nodeName, (a = le[s]) || (r = o.body.appendChild(o.createElement(s)), a = C.css(r, "display"), r.parentNode.removeChild(r), "none" === a && (a = "block"), le[s] = a)))) : "none" !== n && (l[c] = "none", Y.set(i, "display", n)));
        for (c = 0; c < u; c++)
        ...
        for (var o, s, a, l, c, u = t.createDocumentFragment(), f = [], d = 0, p = e.length; d < p; d++)
            if ((o = e[d]) || 0 === o)
                if ("object" === h(o))
                    ...
                    for (s = s || u.appendChild(t.createElement("div")), a = (fe.exec(o) || ["", ""])[1].toLowerCase(), a = pe[a] || pe._default, s.innerHTML = a[1] + C.htmlPrefilter(o) + a[2], c = a[0]; c--;)
                        s = s.lastChild;
    ...
    C.event = {
        ...
        add: function(t, e, n, i, r) {
            var o,
                ...
                h = Y.get(t);
            if (X(t))
                for (n.handler && (n = (o = n).handler, r = o.selector), r && C.find.matchesSelector(ie, r), n.guid || (n.guid = C.guid++), (a = h.events) || (a = h.events = Object.create(null)), (s = h.handle) || (s = h.handle = function(e) {
                    return void 0 !== C && C.event.triggered !== e.type ? C.event.dispatch.apply(t, arguments) : void 0
                }), l = (e = (e || "").match(H) || [""]).length; l--;)
                    f = p = (c = _e.exec(e[l]) || [])[1],
                    d = (c[2] || "").split(".").sort(),
                    f && (u = C.event.special[f] || {}, f = (r ? u.delegateType : u.bindType) || f, u = C.event.special[f] || {}, c = C.extend({
                        type: f,
                        origType: p,
                        data: i,
                        handler: n,
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(H) || [""]).length; c--;)
                    if (p = g = (a = _e.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), p) {
                        for (f = C.event.special[p] || {}, d = l[p = (i ? f.delegateType : f.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;)
                            u = d[o],
                            !r && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(o, 1), u.selector && d.delegateCount--, f.remove && f.remove.call(e, u));
            ...
            if (a.delegateTarget = this, !e.preDispatch || !1 !== e.preDispatch.call(this, a)) {
                for (o = C.event.handlers.call(this, a, l), t = 0; (i = o[t++]) && !a.isPropagationStopped();)
                    for (a.currentTarget = i.elem, n = 0; (r = i.handlers[n++]) && !a.isImmediatePropagationStopped();)
                        a.rnamespace && !1 !== r.namespace && !a.rnamespace.test(r.namespace) || (a.handleObj = r, a.data = r.data, void 0 !== (r = ((C.event.special[r.origType] || {}).handle || r.handler).apply(i.elem, s)) && !1 === (a.result = r) && (a.preventDefault(), a.stopPropagation()));
    ...
    function Xe(e, t, n) {
        var i,
            r,
            o = e.style;
        return (n = n || Ue(e)) && ("" !== (r = n.getPropertyValue(t) || n[t]) || re(e) || (r = C.style(e, t)), !y.pixelBoxStyles() && $e.test(r) && ze.test(t) && (i = o.width, e = o.minWidth, t = o.maxWidth, o.minWidth = o.maxWidth = o.width = r, r = n.width, o.width = i, o.minWidth = e, o.maxWidth = t)), void 0 !== r ? r + "" : r
    }
    function Ke(e, t) {
        return {
            get: function() {
    ...
    function Ye() {
        var e;
        Fe && (Qe.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", Fe.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", ie.appendChild(Qe).appendChild(Fe), e = E.getComputedStyle(Fe), Me = "1%" !== e.top, We = 12 === Ve(e.marginLeft), Fe.style.right = "60%", Re = 36 === Ve(e.right), Ie = 36 === Ve(e.width), Fe.style.position = "absolute", qe = 12 === Ve(Fe.offsetWidth / 3), ie.removeChild(Qe), Fe = null)
    }
    function Ve(e) {
        return Math.round(parseFloat(e))
    }
    Qe = T.createElement("div"),
    (Fe = T.createElement("div")).style && (Fe.style.backgroundClip = "content-box", Fe.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === Fe.style.backgroundClip, C.extend(y, {
        ...
        reliableTrDimensions: function() {
            var e,
                t,
                n;
            return null == Be && (e = T.createElement("table"), n = T.createElement("tr"), t = T.createElement("div"), e.style.cssText = "position:absolute;left:-11111px", n.style.height = "1px", t.style.height = "9px", ie.appendChild(e).appendChild(n).appendChild(t), n = E.getComputedStyle(n), Be = 3 < parseInt(n.height), ie.removeChild(e)), Be
        }
    }));
    ...
    function st(e, t, n, i, r, o) {
        ...
        for (; s < 4; s += 2)
            ...
            i ? ("content" === n && (l -= C.css(e, "padding" + ne[s], !0, r)), "margin" !== n && (l -= C.css(e, "border" + ne[s] + "Width", !0, r))) : (l += C.css(e, "padding" + ne[s], !0, r), "padding" !== n ? l += C.css(e, "border" + ne[s] + "Width", !0, r) : a += C.css(e, "border" + ne[s] + "Width", !0, r));
    ...
    C.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                null != n && n == n && ("number" !== o || l || (n += r && r[3] || (C.cssNumber[a] ? "" : "px")), y.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
    ...
    C.Animation = C.extend(vt, {
        ...
        prefilters: [function(e, t, n) {
            ...
            if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
                for (i in u && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = g && g.display) && (c = Y.get(e, "display")), "none" === (u = C.css(e, "display")) && (c ? u = c : (ce([e], !0), c = e.style.display || c, u = C.css(e, "display"), ce([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === C.css(e, "float") && (l || (f.done(function() {
                    p.display = c
    ...
    C.extend({
        attr: function(e, t, n) {
            var i,
                ...
                o = e.nodeType;
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? C.prop(e, t, n) : (1 === o && C.isXMLDoc(e) || (r = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? yt : void 0)), void 0 !== n ? null === n ? void C.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : !(r && "get" in r && null !== (i = r.get(e, t))) && null == (i = C.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        toggleClass: function(r, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : b(r) ? this.each(function(e) {
                ...
                if (s)
                    ...
                    void 0 !== r && "boolean" != o || ((e = Et(this)) && Y.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", !e && !1 !== r && Y.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
    ...
    C.extend(C.event, {
        trigger: function(e, t, n, i) {
            ...
            if (3 !== n.nodeType && 8 !== n.nodeType && !At.test(d + C.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(), p.sort()), a = d.indexOf(":") < 0 && "on" + d, (e = e[C.expando] ? e : new C.Event(d, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), c = C.event.special[d] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!i && !c.noBubble && !g(n)) {
                    for (s = c.delegateType || d, At.test(s + d) || (h = h.parentNode); h; h = h.parentNode)
                        f.push(h),
                        o = h;
                ...
                return e.type = d, i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(f.pop(), t) || !X(n) || a && b(n[d]) && !g(n) && ((o = n[a]) && (n[a] = null), C.event.triggered = d, e.isPropagationStopped() && u.addEventListener(d, kt), n[d](), e.isPropagationStopped() && u.removeEventListener(d, kt), C.event.triggered = void 0, o && (n[a] = o)), e.result
            }
        },
    ...
    C.extend({
        ...
        ajax: function(e, t) {
            ...
            if (v.promise(w), h.url = ((e || h.url || jt.href) + "").replace(Bt, jt.protocol + "//"), h.type = t.method || t.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(H) || [""], null == h.crossDomain) {
                i = T.createElement("a");
                try {
                    i.href = h.url,
                    i.href = i.href,
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = C.param(h.data, h.traditional)), zt(Wt, h, t, w), d)
                return w;
            for (r in (p = C.event && h.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Rt.test(h.type), c = h.url.replace(Mt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ht, "+")) : (o = h.url.slice(c.length), h.data && (h.processData || "string" == typeof h.data) && (c += (Dt.test(c) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (c = c.replace(It, "$1"), o = (Dt.test(c) ? "&" : "?") + "_=" + St.guid++ + o), h.url = c + o), h.ifModified && (C.lastModified[c] && w.setRequestHeader("If-Modified-Since", C.lastModified[c]), C.etag[c] && w.setRequestHeader("If-None-Match", C.etag[c])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && w.setRequestHeader("Content-Type", h.contentType), w.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : h.accepts["*"]), h.headers)
                w.setRequestHeader(r, h.headers[r]);
            if (h.beforeSend && (!1 === h.beforeSend.call(g, w, h) || d))
                return w.abort();
            if (_ = "abort", y.add(h.complete), w.done(h.success), w.fail(h.error), l = zt(Qt, h, t, w)) {
    ...
    C.ajaxPrefilter("json jsonp", function(e, t, n) {
        ...
        if (s || "jsonp" === e.dataTypes[0])
            return i = e.jsonpCallback = b(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Gt, "$1" + i) : !1 !== e.jsonp && (e.url += (Dt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
    ...
    C.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (y.createHTMLDocument ? ((i = (t = T.implementation.createHTMLDocument("")).createElement("base")).href = T.location.href, t.head.appendChild(i)) : t = T), i = !n && [], (n = j.exec(e)) ? [t.createElement(n[1])] : (n = ve([e], t, i), i && i.length && C(i).remove(), C.merge([], n.childNodes)));
        var i
    },
...
function(t) {
    ...
    i.console && i.console.log && (a && e("3.0.0") || i.console.log("JQMIGRATE: jQuery 3.0.0+ REQUIRED"), a.migrateWarnings && i.console.log("JQMIGRATE: Migrate plugin loaded multiple times"), i.console.log("JQMIGRATE: Migrate is installed" + (a.migrateMute ? "" : " with logging active") + ", version " + a.migrateVersion));
    var n = {};
    function l(e) {
        var t = i.console;
    ...
    e("3.2.0") && (r(a, "nodeName", function(e, t) {
        return e.nodeName && e.nodeName.toLowerCase() === t.toLowerCase()
    }, "jQuery.nodeName is deprecated"), r(a, "isArray", Array.isArray, "jQuery.isArray is deprecated; use Array.isArray")),
    ...
    a.ajax && (s = a.ajax, c = /(=)\?(?=&|$)|\?\?/, a.ajax = function() {
    ...
    a.fn.css = function(e, t) {
        ...
        return e && "object" == typeof e && !Array.isArray(e) ? (a.each(e, function(e, t) {
            a.fn.css.call(i, e, t)
        }), this) : ("number" == typeof t && (t = n = b(e), x.test(t) && E.test(t[0].toUpperCase() + t.slice(1)) || a.cssNumber[n] || l('Number-typed values are deprecated for jQuery.fn.css( "' + e + '", value )')), _.apply(this, arguments))
    };
    var T,
        C,
        k,
    ...
    a.data = function(e, t, n) {
        ...
        if (t && "object" == typeof t && 2 === arguments.length) {
            for (o in i = a.hasData(e) && j.call(this, e), r = {}, t)
                o !== b(o) ? (l("jQuery.data() always sets/gets camelCased names: " + o), i[o] = t[o]) : r[o] = t[o];
            return j.call(this, e, r), t
        }
        return t && "string" == typeof t && t !== b(t) && (i = a.hasData(e) && j.call(this, e)) && t in i ? (l("jQuery.data() always sets/gets camelCased names: " + t), 2 < arguments.length && (i[t] = n), i[t]) : j.apply(this, arguments)
    },
    a.fx && (k = a.Tween.prototype.run, A = function(e) {
        return e
    }, a.Tween.prototype.run = function() {
        1 < a.easing[this.easing].length && (l("'jQuery.easing." + this.easing.toString() + "' should use only one argument"), a.easing[this.easing] = A),
    ...
    a.each(["load", "unload", "error"], function(e, t) {
        a.fn[t] = function() {
            ...
            return "load" === t && "string" == typeof e[0] ? S.apply(this, e) : (l("jQuery.fn." + t + "() is deprecated"), e.splice(0, 0, t), arguments.length ? this.on.apply(this, e) : (this.triggerHandler.apply(this, e), this))
        }
    }),
    ...
    a.fn.offset = function() {
        var e = this[0];
        return !e || e.nodeType && e.getBoundingClientRect ? I.apply(this, arguments) : (l("jQuery.fn.offset() requires a valid DOM element"), arguments.length ? this : void 0)
    },
    ...
    }, a.Deferred && (q = a.Deferred, R = [["resolve", "done", a.Callbacks("once memory"), a.Callbacks("once memory"), "resolved"], ["reject", "fail", a.Callbacks("once memory"), a.Callbacks("once memory"), "rejected"], ["notify", "progress", a.Callbacks("memory"), a.Callbacks("memory")]], a.Deferred = function(e) {
        var o = q(),
            s = o.promise();
    ...
    }, a.Deferred.exceptionHook = q.exceptionHook), a
}),
function(e, t) {
    ...
    function m(r, o, s) {
        Object.keys(s).forEach(function(e) {
            var t,
                n = s[e],
                i = o[e],
                t = i && h(i) ? "element" : null == (t = i) ? "" + t : {}.toString.call(t).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    function q(e, t, n, i, r) {
        var o,
            ...
            p,
            h;
        "string" == typeof t && e && (n || (n = i, i = null), o = (l = I(t, n, i))[0], s = l[1], a = l[2], (c = M(l = (c = H(e))[a] || (c[a] = {}), s, o ? n : null)) ? c.oneOff = c.oneOff && r : (t = P(s, t.replace(A, "")), (i = o ? (d = e, p = n, h = i, function e(t) {
            for (var n = d.querySelectorAll(p), i = t.target; i && i !== this; i = i.parentNode)
                for (var r = n.length; r--;)
                    if (n[r] === i)
                        return t.delegateTarget = i, e.oneOff && B.off(d, t.type, h), h.apply(i, [t]);
            return null
        }) : (u = e, f = n, function e(t) {
            return t.delegateTarget = u, e.oneOff && B.off(u, t.type, f), f.apply(u, [t])
    ...
    var B = {
        ...
        $ = function(e) {
            ...
            return t.close = function(e) {
                ...
                e.classList.contains("fade") ? (t = p(e), B.one(e, x, function() {
    ...
    e(function() {
        var e,
            t = b();
        t && (e = t.fn[Q], t.fn[Q] = $.jQueryInterface, t.fn[Q].Constructor = $, t.fn[Q].noConflict = function() {
    ...
    e(function() {
        var e,
            t = b();
        t && (e = t.fn[U], t.fn[U] = K.jQueryInterface, t.fn[U].Constructor = K, t.fn[U].noConflict = function() {
    ...
    var G = {
        ...
        ue = function(n) {
            ...
            return e.next = function() {
                ...
                e || (this._isPaused = !0),
                J.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (r(this._element), this.cycle(!0)),
                ...
                this._pointerEvent ? (B.on(this._element, "pointerdown.bs.carousel", e), B.on(this._element, "pointerup.bs.carousel", t), this._element.classList.add("pointer-event")) : (B.on(this._element, "touchstart.bs.carousel", e), B.on(this._element, "touchmove.bs.carousel", function(e) {
                ...
                var n,
                    ...
                    c = e === re ? (n = "carousel-item-start", i = "carousel-item-next", "left") : (n = "carousel-item-end", i = "carousel-item-prev", "right");
                a && a.classList.contains(ae) ? this._isSliding = !1 : this._triggerSlideEvent(a, c).defaultPrevented || o && a && (this._isSliding = !0, t && this.pause(), this._setActiveIndicatorElement(a), this._activeElement = a, this._element.classList.contains("slide") ? (a.classList.add(i), y(a), o.classList.add(n), a.classList.add(n), e = p(o), B.one(o, x, function() {
                ...
                }), g(o, e)) : (o.classList.remove(ae), a.classList.add(ae), this._isSliding = !1, B.trigger(this._element, se, {
                    relatedTarget: a,
                    direction: c,
                    from: s,
                    to: l
                ...
                var t,
                    n,
                    i = d(this);
                i && i.classList.contains("carousel") && (t = l({}, G.getDataAttributes(i), G.getDataAttributes(this)), (n = this.getAttribute("data-bs-slide-to")) && (t.interval = !1), o.carouselInterface(i, t), n && C(i, ee).to(n), e.preventDefault())
            }, a(o, null, [{
                key: "Default",
                get: function() {
                    return ne
    ...
    e(function() {
        var e,
            t = b();
        t && (e = t.fn[Z], t.fn[Z] = ue.jQueryInterface, t.fn[Z].Constructor = ue, t.fn[Z].noConflict = function() {
            ...
            return e.toggle = function() {
                ...
                if (!this._isTransitioning && !this._element.classList.contains(ge)) {
                    ...
                    B.trigger(this._element, "show.bs.collapse").defaultPrevented || (n && n.forEach(function(e) {
                        ...
                        r || T(e, de, null)
                    }), e = this._getDimension(), this._element.classList.remove(me), this._element.classList.add(ve), this._element.style[e] = 0, this._triggerArray.length && this._triggerArray.forEach(function(e) {
                        e.classList.remove(ye),
                        e.setAttribute("aria-expanded", !0)
                    }), this.setTransitioning(!0), o = "scroll" + (e[0].toUpperCase() + e.slice(1)), n = p(this._element), B.one(this._element, x, function() {
                        t._element.classList.remove(ve),
                        t._element.classList.add(me, ge),
                        t._element.style[e] = "",
                        t.setTransitioning(!1),
                        B.trigger(t._element, "shown.bs.collapse")
                    }), g(this._element, n), this._element.style[e] = this._element[o] + "px")
                }
            }, e.hide = function() {
                var e = this;
                    ...
                    if (0 < n)
                        for (var i = 0; i < n; i++) {
                            var r = this._triggerArray[i],
                                o = d(r);
                            o && !o.classList.contains(ge) && (r.classList.add(ye), r.setAttribute("aria-expanded", !1))
                        }
                ...
                var n;
                e && t.length && (n = e.classList.contains(ge), t.forEach(function(e) {
    ...
    e(function() {
        var e,
            t = b();
        t && (e = t.fn[fe], t.fn[fe] = _e.jQueryInterface, t.fn[fe].Constructor = _e, t.fn[fe].noConflict = function() {
        ...
        fn: function(e) {
            ...
            Object.keys(r.elements).forEach(function(e) {
                var t = r.styles[e] || {},
                    n = r.attributes[e] || {},
                    i = r.elements[e];
                Ue(i) && Qe(i) && (Object.assign(i.style, t), Object.keys(n).forEach(function(e) {
                    var t = n[e];
        ...
        effect: function(e) {
            ...
            return Object.assign(i.elements.popper.style, r.popper), i.elements.arrow && Object.assign(i.elements.arrow.style, r.arrow), function() {
                Object.keys(i.elements).forEach(function(e) {
                    ...
                    Ue(t) && Qe(t) && (Object.assign(t.style, e), Object.keys(n).forEach(function(e) {
                        t.removeAttribute(e)
                    }))
                })
            }
    ...
    var st = {
            ...
            fn: function(e) {
                ...
                s && a && (t = r.modifiersData[o + "#persistent"].padding, n = Ke(s), i = "y" === c ? we : Te, e = "y" === c ? xe : Ee, l = r.rects.reference[u] + r.rects.reference[c] - a[c] - r.rects.popper[u], a = a[c] - r.rects.reference[c], s = (s = et(s)) ? "y" === c ? s.clientHeight || 0 : s.clientWidth || 0 : 0, a = l / 2 - a / 2, i = t[i], e = s - n[u] - t[e], e = nt(i, a = s / 2 - n[u] / 2 + a, e), r.modifiersData[o] = ((o = {})[c] = e, o.centerOffset = e - a, o))
            },
            effect: function(e) {
                var t = e.state,
                    n = e.options,
    ...
    function lt(e) {
        var t = e.popper,
            ...
            s = e.gpuAcceleration,
            a = e.adaptive,
            l = (f = (p = r).x, d = p.y, p = window.devicePixelRatio || 1, {
            ...
            p = we,
            l = window;
        a && ((r = et(t)) === Fe(t) && (r = Ge(t)), i === we && (p = xe, u -= r.clientHeight - n.height, u *= s ? 1 : -1), i === Te && (d = Ee, c -= r.clientWidth - n.width, c *= s ? 1 : -1));
        var a = Object.assign({
            position: o
        }, a && at);
        return s ? Object.assign(Object.assign({}, a), {}, ((s = {})[p] = f ? "0" : "", s[d] = e ? "0" : "", s.transform = (l.devicePixelRatio || 1) < 2 ? "translate(" + c + "px, " + u + "px)" : "translate3d(" + c + "px, " + u + "px, 0)", s)) : Object.assign(Object.assign({}, a), {}, ((a = {})[p] = f ? u + "px" : "", a[d] = e ? c + "px" : "", a.transform = "", a))
    }
    var ct = {
            name: "computeStyles",
            enabled: !0,
    ...
    var ft = {
            ...
            effect: function(e) {
                ...
                }), o && s.addEventListener("resize", n.update, ut), function() {
    ...
    function xt(e, t) {
        return t === De ? wt((o = Fe(r = e), s = Ge(r), a = o.visualViewport, l = s.clientWidth, c = s.clientHeight, s = o = 0, a && (l = a.width, c = a.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (o = a.offsetLeft, s = a.offsetTop)), {
            width: l,
            height: c,
            x: o + yt(r),
            y: s
        })) : Ue(t) ? ((i = mt(n = t)).top = i.top + n.clientTop, i.left = i.left + n.clientLeft, i.bottom = i.top + n.clientHeight, i.right = i.left + n.clientWidth, i.width = n.clientWidth, i.height = n.clientHeight, i.x = i.left, i.y = i.top, i) : wt((r = Ge(e), s = Ge(r), t = vt(r), n = r.ownerDocument.body, i = Math.max(s.scrollWidth, s.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0), e = Math.max(s.scrollHeight, s.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0), r = -t.scrollLeft + yt(r), t = -t.scrollTop, "rtl" === Ve(n || s).direction && (r += Math.max(s.clientWidth, n ? n.clientWidth : 0) - i), {
            width: i,
            height: e,
            x: r,
            y: t
    ...
    function Et(n, e, t) {
        var i,
            r,
            o,
            e = "clippingParents" === e ? (r = _t(Je(i = n)), $e(o = 0 <= ["absolute", "fixed"].indexOf(Ve(i).position) && Ue(i) ? et(i) : i) ? r.filter(function(e) {
    ...
    function kt(e, t) {
        ...
        return u === Le && e && (i = e[r], Object.keys(f).forEach(function(e) {
            ...
            var s = e.state,
                ...
                e = Pe.reduce(function(e, t) {
                    var n,
                        ...
                        r,
                        o;
                    return e[t] = (n = t, i = s.rects, r = a, o = Xe(n), t = 0 <= [Te, we].indexOf(o) ? -1 : 1, r = (r = (n = "function" == typeof r ? r(Object.assign(Object.assign({}, i), {}, {
                        placement: n
                    })) : r)[0]) || 0, n = ((n = n[1]) || 0) * t, 0 <= [Te, Ee].indexOf(o) ? {
                        x: n,
                        y: r
                    } : {
                        x: r,
                ...
                i = (t = e[s.placement]).x,
                t = t.y;
            null != s.modifiersData.popperOffsets && (s.modifiersData.popperOffsets.x += i, s.modifiersData.popperOffsets.y += t),
            s.modifiersData[n] = e
        }
    };
    var Ot = {
    ...
    var Nt = {
        ...
        fn: function(e) {
            var t,
                ...
                _ = n.rects.reference,
                w = n.rects.popper,
                x = "function" == typeof p ? p(Object.assign(Object.assign({}, n.rects), {}, {
            ...
            e && (o && (d = "y" === y ? we : Te, a = "y" === y ? xe : Ee, l = "y" === y ? "height" : "width", t = e[y], u = e[y] + h[d], c = e[y] - h[a], g = f ? -w[l] / 2 : 0, p = (m === Ae ? _ : w)[l], o = m === Ae ? -w[l] : -_[l], m = n.elements.arrow, w = f && m ? Ke(m) : {
                width: 0,
                height: 0
            }, d = (m = n.modifiersData["arrow#persistent"] ? n.modifiersData["arrow#persistent"].padding : it())[d], a = m[a], w = nt(0, _[l], w[l]), d = v ? _[l] / 2 - g - w - d - x : p - w - d - x, w = v ? -_[l] / 2 + g + w + a + x : o + w + a + x, x = (a = n.elements.arrow && et(n.elements.arrow)) ? "y" === y ? a.clientTop || 0 : a.clientLeft || 0 : 0, a = n.modifiersData.offset ? n.modifiersData.offset[n.placement][y] : 0, x = e[y] + d - a - x, a = e[y] + w - a, c = nt(f ? Math.min(u, x) : u, t, f ? Math.max(c, a) : c), e[y] = c, i[y] = c - t), s && (t = "x" === y ? we : Te, s = "x" === y ? xe : Ee, s = nt((y = e[b]) + h[t], y, y - h[s]), e[b] = s, i[b] = s - y), n.modifiersData[r] = i)
        },
        requiresIfExists: ["offset"]
    };
    function Pt(e, t, n) {
        ...
        } : vt(o)), Ue(t) ? ((e = mt(t)).x += t.clientLeft, e.y += t.clientTop) : i && (e.x = yt(i))), {
            ...
            var n,
                ...
                c = {
                    ...
                    setOptions: function(e) {
                        ...
                        var n,
                            t,
                            e = (e = [].concat(f, s.options.modifiers), t = e.reduce(function(e, t) {
                                var n = e[t.name];
                        ...
                        if (!l) {
                            ...
                            if (It(t, e)) {
                                ...
                                for (var n, i, r, o = 0; o < s.orderedModifiers.length; o++)
                                    !0 !== s.reset ? (n = (r = s.orderedModifiers[o]).fn, i = void 0 === (i = r.options) ? {} : i, r = r.name, "function" == typeof n && (s = n({
                                        state: s,
                                        options: i,
                                        name: r,
                                        instance: c
    ...
    var Rt = qt(),
        ...
        fn = function(n) {
            function c(e, t) {
                e = n.call(this, e) || this;
                return e._popper = null, e._config = e._getConfig(t), e._menu = e._getMenuElement(), e._inNavbar = e._detectNavbar(), e._addEventListeners(), e
            }
            u(c, n);
            var e = c.prototype;
            return e.toggle = function() {
                var e;
                this._element.disabled || this._element.classList.contains(Jt) || (e = this._element.classList.contains(Zt), c.clearMenus(), e || this.show())
            }, e.show = function() {
                if (!(this._element.disabled || this._element.classList.contains(Jt) || this._menu.classList.contains(Zt))) {
                    ...
                    if (!B.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                        if (!this._inNavbar) {
                            ...
                            var n = this._element;
                            "parent" === this._config.reference ? n = e : h(this._config.reference) && (n = this._config.reference, void 0 !== this._config.reference.jquery && (n = this._config.reference[0])),
                ...
                var e,
                    t;
                this._element.disabled || this._element.classList.contains(Jt) || !this._menu.classList.contains(Zt) || (e = c.getParentFromElement(this._element), t = {
                    relatedTarget: this._element
                }, B.trigger(e, Vt, t).defaultPrevented || (this._popper && this._popper.destroy(), this._menu.classList.toggle(Zt), this._element.classList.toggle(Zt), B.trigger(e, Gt, t)))
            }, e.dispose = function() {
                n.prototype.dispose.call(this),
                ...
                return e = l({}, this.constructor.Default, G.getDataAttributes(this._element), e), m(Ft, e, this.constructor.DefaultType), e
                ...
                if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                    for (var t = J.find(en), n = 0, i = t.length; n < i; n++) {
                        ...
                        a && (r = a._menu, t[n].classList.contains(Zt) && (e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && "Tab" === e.key) && r.contains(e.target) || B.trigger(s, Vt, l).defaultPrevented || ("ontouchstart" in document.documentElement && (o = []).concat.apply(o, document.body.children).forEach(function(e) {
                            return B.off(e, "mouseover", null, v())
                        }), t[n].setAttribute("aria-expanded", "false"), a._popper && a._popper.destroy(), r.classList.remove(Zt), t[n].classList.remove(Zt), B.trigger(s, Gt, l))))
                    }
            }, c.getParentFromElement = function(e) {
                return d(e) || e.parentNode
            }, c.dataApiKeydownHandler = function(e) {
                if ((/input|textarea/i.test(e.target.tagName) ? !("Space" === e.key || e.key !== zt && (e.key !== Kt && e.key !== Xt || e.target.closest(tn))) : Yt.test(e.key)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains(Jt))) {
                    var t = c.getParentFromElement(this),
                        n = this.classList.contains(Zt);
                    if (e.key === zt)
                        return (this.matches(en) ? this : J.prev(this, en)[0]).focus(), void c.clearMenus();
                    n && "Space" !== e.key ? (n = J.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", t).filter(s)).length && (t = n.indexOf(e.target), e.key === Xt && 0 < t && t--, e.key === Kt && t < n.length - 1 && t++, n[t = -1 === t ? 0 : t].focus()) : c.clearMenus()
                }
            }, a(c, null, [{
                key: "Default",
                get: function() {
    ...
    e(function() {
        var e,
            t = b();
        t && (e = t.fn[Ft], t.fn[Ft] = fn.jQueryInterface, t.fn[Ft].Constructor = fn, t.fn[Ft].noConflict = function() {
    ...
    var dn = "modal",
        ...
        Dn = function(i) {
            function r(e, t) {
                ...
                return n._config = n._getConfig(t), n._dialog = J.findOne(".modal-dialog", e), n._backdrop = null, n._isShown = !1, n._isBodyOverflowing = !1, n._ignoreBackdropClick = !1, n._isTransitioning = !1, n._scrollbarWidth = 0, n
            }
            u(r, i);
            var e = r.prototype;
            return e.toggle = function(e) {
                ...
                var t,
                    n = this;
                this._isShown || this._isTransitioning || (this._element.classList.contains(Cn) && (this._isTransitioning = !0), t = B.trigger(this._element, yn, {
                    relatedTarget: e
                }), this._isShown || t.defaultPrevented || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), B.on(this._element, wn, '[data-bs-dismiss="modal"]', function(e) {
                    return n.hide(e)
                ...
                var t = this;
                e && e.preventDefault(),
                this._isShown && !this._isTransitioning && (B.trigger(this._element, "hide.bs.modal").defaultPrevented || (this._isShown = !1, (e = this._element.classList.contains(Cn)) && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), B.off(document, bn), this._element.classList.remove(kn), B.off(this._element, wn), B.off(this._dialog, En), e ? (e = p(this._element), B.one(this._element, x, function(e) {
                ...
                n ? (n = p(this._dialog), B.one(this._dialog, x, i), g(this._dialog, n)) : i()
                ...
                this._isShown && this._config.backdrop ? (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), document.body.appendChild(this._backdrop), B.on(this._element, wn, function(e) {
                ...
                }), i && y(this._backdrop), this._backdrop.classList.add(kn), i ? (t = p(this._backdrop), B.one(this._backdrop, x, e), g(this._backdrop, t)) : e()) : !this._isShown && this._backdrop ? (this._backdrop.classList.remove(kn), i = function() {
                    n._removeBackdrop(),
                    e()
                }, this._element.classList.contains(Cn) ? (t = p(this._backdrop), B.one(this._backdrop, x, i), g(this._backdrop, t)) : i()) : e()
            }, e._triggerBackdropTransition = function() {
                var e,
                    t,
                    n = this;
                B.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented || ((e = this._element.scrollHeight > document.documentElement.clientHeight) || (this._element.style.overflowY = "hidden"), this._element.classList.add(An), t = p(this._dialog), B.off(this._element, x), B.one(this._element, x, function() {
                ...
                }), e = document.body.style.paddingRight, t = window.getComputedStyle(document.body)["padding-right"], G.setDataAttribute(document.body, "padding-right", e), document.body.style.paddingRight = Number.parseFloat(t) + this._scrollbarWidth + "px"),
                document.body.classList.add(Tn)
            }, e._resetScrollbar = function() {
                J.find(jn).forEach(function(e) {
                    var t = G.getDataAttribute(e, "padding-right");
                    void 0 !== t && (G.removeDataAttribute(e, "padding-right"), e.style.paddingRight = t)
                }),
                J.find(Sn).forEach(function(e) {
                    var t = G.getDataAttribute(e, "margin-right");
                    void 0 !== t && (G.removeDataAttribute(e, "margin-right"), e.style.marginRight = t)
                });
                var e = G.getDataAttribute(document.body, "padding-right");
                void 0 === e ? document.body.style.paddingRight = "" : (G.removeDataAttribute(document.body, "padding-right"), document.body.style.paddingRight = e)
    ...
    B.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', function(e) {
        ...
        var i = C(n, pn);
        i || (e = l({}, G.getDataAttributes(n), G.getDataAttributes(this)), i = new Dn(n, e)),
        i.show(this)
    }),
    e(function() {
        var e,
            t = b();
        t && (e = t.fn[dn], t.fn[dn] = Dn.jQueryInterface, t.fn[dn].Constructor = Dn, t.fn[dn].noConflict = function() {
    ...
    var Hn = "tooltip",
        ...
        Vn = function(n) {
            ...
            return e.enable = function() {
                ...
                var t,
                    n;
                this._isEnabled && (e ? (t = this.constructor.DATA_KEY, (n = C(e.delegateTarget, t)) || (n = new this.constructor(e.delegateTarget, this._getDelegateConfig()), T(e.delegateTarget, t, n)), n._activeTrigger.click = !n._activeTrigger.click, n._isWithActiveTrigger() ? n._enter(null, n) : n._leave(null, n)) : this.getTipElement().classList.contains(zn) ? this._leave(null, this) : this._enter(null, this))
            }, e.dispose = function() {
                ...
                }, this.tip.classList.contains(Un) ? (i = p(this.tip), B.one(this.tip, x, n), g(this.tip, i)) : n()))
            }, e.hide = function() {
                var e,
                    t,
                    n,
                ...
                }, B.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented || (e.classList.remove(zn), "ontouchstart" in document.documentElement && (n = []).concat.apply(n, document.body.children).forEach(function(e) {
                    return B.off(e, "mouseover", v)
                }), this._activeTrigger.click = !1, this._activeTrigger[Yn] = !1, this._activeTrigger[Kn] = !1, this.tip.classList.contains(Un) ? (n = p(e), B.one(e, x, t), g(e, n)) : t(), this._hoverState = ""))
            }, e.update = function() {
                ...
                if (null !== e)
                    return "object" == typeof t && h(t) ? (t.jquery && (t = t[0]), void (this.config.html ? t.parentNode !== e && (e.innerHTML = "", e.appendChild(t)) : e.textContent = t.textContent)) : void (this.config.html ? (this.config.sanitize && (t = Pn(t, this.config.allowList, this.config.sanitizeFn)), e.innerHTML = t) : e.textContent = t)
            }, e.getTitle = function() {
                ...
                this.config.trigger.split(" ").forEach(function(e) {
                    ...
                    "click" === e ? B.on(n._element, n.constructor.Event.CLICK, n.config.selector, function(e) {
                        return n.toggle(e)
                    }) : "manual" !== e && (t = e === Kn ? n.constructor.Event.MOUSEENTER : n.constructor.Event.FOCUSIN, e = e === Kn ? n.constructor.Event.MOUSELEAVE : n.constructor.Event.FOCUSOUT, B.on(n._element, t, n.config.selector, function(e) {
                        return n._enter(e)
                ...
                (t = t || C(e.delegateTarget, n)) || (t = new this.constructor(e.delegateTarget, this._getDelegateConfig()), T(e.delegateTarget, n, t)),
                e && (t._activeTrigger["focusin" === e.type ? Yn : Kn] = !0),
                t.getTipElement().classList.contains(zn) || t._hoverState === Xn ? t._hoverState = Xn : (clearTimeout(t._timeout), t._hoverState = Xn, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function() {
                ...
                return Object.keys(t).forEach(function(e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), m(Hn, e, this.constructor.DefaultType), e.sanitize && (e.template = Pn(e.template, e.allowList, e.sanitizeFn)), e
    ...
    e(function() {
        var e,
            t = b();
        t && (e = t.fn[Hn], t.fn[Hn] = Vn.jQueryInterface, t.fn[Hn].Constructor = Vn, t.fn[Hn].noConflict = function() {
        ...
        oi = function(e) {
            ...
            return t.isWithContent = function() {
                ...
                return this.each(function() {
                    ...
                    if ((e || !/dispose|hide/.test(n)) && (e || (e = new i(this, t), T(this, Jn, e)), "string" == typeof n)) {
                        if (void 0 === e[n])
                            throw new TypeError('No method named "' + n + '"');
                        e[n]()
                    }
    ...
    e(function() {
        var e,
            t = b();
        t && (e = t.fn[Gn], t.fn[Gn] = oi.jQueryInterface, t.fn[Gn].Constructor = oi, t.fn[Gn].noConflict = function() {
    ...
    var si = "scrollspy",
        ...
        mi = function(i) {
            function n(e, t) {
                var n = i.call(this, e) || this;
                return n._scrollElement = "BODY" === e.tagName ? window : e, n._config = n._getConfig(t), n._selector = n._config.target + " " + pi + ", " + n._config.target + " " + hi + ", " + n._config.target + " ." + fi, n._offsets = [], n._targets = [], n._activeTarget = null, n._scrollHeight = 0, B.on(n._scrollElement, "scroll.bs.scrollspy", function(e) {
                    return n._process(e)
            ...
            return e.refresh = function() {
                ...
                var t;
                return "string" != typeof (e = l({}, ci, "object" == typeof e && e ? e : {})).target && h(e.target) && ((t = e.target.id) || (t = o(si), e.target.id = t), e.target = "#" + t), m(si, e, ui), e
                ...
                var e = this._selector.split(",").map(function(e) {
                    ...
                    e = J.findOne(e.join(","));
                e.classList.contains(fi) ? (J.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(di), e.classList.add(di)) : (e.classList.add(di), J.parents(e, ".nav, .list-group").forEach(function(e) {
    ...
    e(function() {
        var e,
            t = b();
        t && (e = t.fn[si], t.fn[si] = mi.jQueryInterface, t.fn[si].Constructor = mi, t.fn[si].noConflict = function() {
    ...
    var vi = "bs.tab",
        ...
        wi = function(e) {
            ...
            return t.show = function() {
                ...
                r && o ? (o = p(r), r.classList.remove("show"), B.one(r, x, t), g(r, o)) : t()
            }, t._transitionComplete = function(e, t, n) {
                var i;
                t && (t.classList.remove(yi), (i = J.findOne(":scope > .dropdown-menu .active", t.parentNode)) && i.classList.remove(yi), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)),
                e.classList.add(yi),
    ...
    e(function() {
        var e,
            t = b();
        t && (e = t.fn.tab, t.fn.tab = wi.jQueryInterface, t.fn.tab.Constructor = wi, t.fn.tab.noConflict = function() {
        ...
        Si = function(n) {
            ...
            return e.show = function() {
                var e,
                    t,
                    n = this;
                B.trigger(this._element, "show.bs.toast").defaultPrevented || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), e = function() {
                ...
                }, this._element.classList.remove("hide"), y(this._element), this._element.classList.add(ki), this._config.animation ? (t = p(this._element), B.one(this._element, x, e), g(this._element, t)) : e())
            }, e.hide = function() {
                var e,
                    t,
                    n = this;
                ...
                }, this._element.classList.remove(Ci), this._config.animation ? (t = p(this._element), B.one(this._element, x, e), g(this._element, t)) : e()))
            }, e.dispose = function() {
                this._clearTimeout(),
                ...
                return e = l({}, ji, G.getDataAttributes(this._element), "object" == typeof e && e ? e : {}), m(xi, e, this.constructor.DefaultType), e
            }, e._setListeners = function() {
                var e = this;
    ...
    return e(function() {
        var e,
            t = b();
        t && (e = t.fn[xi], t.fn[xi] = Si.jQueryInterface, t.fn[xi].Constructor = Si, t.fn[xi].noConflict = function() {
